...
import { findTrackPreview } from './itunes.js?v=239';
import { pickBestMatch, artistMatches, artistList, preferredQueryArtists } from '../util/track-match.js?v=239';
...
async function getArtistTopPreview(artist) {
  ...
  if (cached === 'itunes' || !cached) {
    const { findArtistTopPreview } = await import('./itunes.js?v=239');
