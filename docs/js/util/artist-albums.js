...
import { loadTrackPlays, loadListenedAlbums } from '../features/history-data.js?v=180';
import { lookupAlbumStats } from './album-stats.js?v=180';
import { getBestAvailableLikes } from '../api.js?v=180';
import { coverUrl } from './cover-size.js?v=180';
