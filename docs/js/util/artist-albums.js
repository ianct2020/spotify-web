...
import { loadTrackPlays, loadListenedAlbums } from '../features/history-data.js?v=161';
import { lookupAlbumStats } from './album-stats.js?v=161';
import { getBestAvailableLikes } from '../api.js?v=161';
import { coverUrl } from './cover-size.js?v=161';
