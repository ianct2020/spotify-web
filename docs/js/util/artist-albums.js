...
import { loadTrackPlays, loadListenedAlbums } from '../features/history-data.js?v=179';
import { lookupAlbumStats } from './album-stats.js?v=179';
import { getBestAvailableLikes } from '../api.js?v=179';
import { coverUrl } from './cover-size.js?v=179';
