...
import { loadTrackPlays, isOwner } from '../features/history-data.js?v=239';
import { getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=239';
import { coverUrl } from './cover-size.js?v=239';
