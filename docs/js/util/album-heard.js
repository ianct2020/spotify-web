...
import { loadTrackPlays, isOwner } from '../features/history-data.js?v=223';
import { getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=223';
import { coverUrl } from './cover-size.js?v=223';
