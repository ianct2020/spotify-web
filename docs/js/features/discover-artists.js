...
import { buildAlbumHeardIndex } from '../util/album-heard.js?v=156';
import { loadFiltros, buildFilterContext, applyDiscoverFilters } from '../util/discover-filters.js?v=156';
import {
  getArtistIdCached,
