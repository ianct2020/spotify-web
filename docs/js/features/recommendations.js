import { spotifyFetch, createPlaylist, addTracksToPlaylist, invalidatePlaylistsCache, getAllLikedTracks } from '../api.js?v=223';
import { hasKey, setKey, hasUsername, getUsername, setUsername, getUserTopArtists, getSimilarArtists, getArtistTopTracks } from '../api/lastfm.js?v=223';
import { showProgress, hideProgress, promptPlaylistName, escapeHtml, pageHeader } from '../ui/components.js?v=223';
import { showToast } from '../ui/toast.js?v=223';
import { getPreview } from '../api/preview-providers.js?v=223';
import { togglePreview, playingKey, isPlayingAudio } from '../ui/preview-player.js?v=223';
import { paintPlayingCard } from '../ui/track-card-row.js?v=223';
import { openTrackCard } from './track-card.js?v=223';
import { openAlbumCard } from './album-card.js?v=223';
import { limpiaParaQuery, titleMatches, artistMatches } from '../util/track-match.js?v=223';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=223';
import { createHiddenStore } from '../util/hidden-sync.js?v=223';
import { recuperarUriDeArtistaKey } from '../util/hidden-recover.js?v=223';
