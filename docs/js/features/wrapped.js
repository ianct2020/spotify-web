...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=171';
import { escapeHtml, pageHeader } from '../ui/components.js?v=171';
import { getPreview } from '../api/preview-providers.js?v=171';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=171';
import { attachHover } from '../ui/preview-player.js?v=171';
...
import { getMyTop } from '../api.js?v=171';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=171';
import { openModal } from '../ui/modal-stack.js?v=171';
import { armReveal, armRevealAll, releaseReveal } from '../ui/reveal.js?v=171';
