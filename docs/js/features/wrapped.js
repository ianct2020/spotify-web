...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=129';
...
import { getMyTop } from '../api.js?v=129';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=129';
import { openModal } from '../ui/modal-stack.js?v=129';
