...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=127';
...
import { getMyTop } from '../api.js?v=127';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=127';
import { openModal } from '../ui/modal-stack.js?v=127';
