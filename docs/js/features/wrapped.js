...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=212';
import { escapeHtml, pageHeader } from '../ui/components.js?v=212';
import { getPreview } from '../api/preview-providers.js?v=212';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=212';
import { attachHover } from '../ui/preview-player.js?v=212';
...
import { getMyTop } from '../api.js?v=212';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=212';
import { openModal } from '../ui/modal-stack.js?v=212';
import { armReveal, armRevealAll, releaseReveal } from '../ui/reveal.js?v=212';
