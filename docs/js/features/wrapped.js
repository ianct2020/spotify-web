...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=112';
...
import { getMyTop } from '../api.js?v=112';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=112';
import { openModal } from '../ui/modal-stack.js?v=112';
