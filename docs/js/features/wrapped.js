...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=213';
import { escapeHtml, pageHeader } from '../ui/components.js?v=213';
import { getPreview } from '../api/preview-providers.js?v=213';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=213';
import { attachHover } from '../ui/preview-player.js?v=213';
...
import { getMyTop } from '../api.js?v=213';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=213';
import { openModal } from '../ui/modal-stack.js?v=213';
import { armReveal, armRevealAll, releaseReveal } from '../ui/reveal.js?v=213';
