...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=133';
...
import { getMyTop } from '../api.js?v=133';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=133';
import { openModal } from '../ui/modal-stack.js?v=133';
