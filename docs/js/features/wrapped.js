...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=223';
import { escapeHtml, pageHeader } from '../ui/components.js?v=223';
import { getPreview } from '../api/preview-providers.js?v=223';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=223';
import { attachHover } from '../ui/preview-player.js?v=223';
...
async function montarAperturaSiSePuede(ruta) {
  ...
  if (!host) return;
  try {
    const mod = await import('../features/wrapped-apertura.js?v=223');
