...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=234';
import { escapeHtml, pageHeader } from '../ui/components.js?v=234';
import { getPreview } from '../api/preview-providers.js?v=234';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=234';
import { attachHover } from '../ui/preview-player.js?v=234';
...
import { getMyTop } from '../api.js?v=234';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=234';
import { openModal } from '../ui/modal-stack.js?v=234';
import { armReveal, armRevealAll, releaseReveal } from '../ui/reveal.js?v=234';
...
async function montarAperturaSiSePuede(ruta) {
  ...
  if (!host) return;
  try {
    const mod = await import('../features/wrapped-apertura.js?v=234');
