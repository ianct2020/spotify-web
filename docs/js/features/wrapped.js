...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=123';
...
import { getMyTop } from '../api.js?v=123';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=123';
import { openModal } from '../ui/modal-stack.js?v=123';
