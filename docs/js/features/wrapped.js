...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=130';
...
import { getMyTop } from '../api.js?v=130';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=130';
import { openModal } from '../ui/modal-stack.js?v=130';
