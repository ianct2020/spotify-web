...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=140';
...
import { getMyTop } from '../api.js?v=140';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=140';
import { openModal } from '../ui/modal-stack.js?v=140';
