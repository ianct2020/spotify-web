...
import { loadHistoryStats, isOwner, ownerLockedMessage } from './history-data.js?v=176';
import { escapeHtml, pageHeader } from '../ui/components.js?v=176';
import { getPreview } from '../api/preview-providers.js?v=176';
import { getArtistLikePreview, getAlbumLikePreview } from '../util/artist-preview.js?v=176';
import { attachHover } from '../ui/preview-player.js?v=176';
...
import { getMyTop } from '../api.js?v=176';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=176';
import { openModal } from '../ui/modal-stack.js?v=176';
import { armReveal, armRevealAll, releaseReveal } from '../ui/reveal.js?v=176';
