...
import { buildAlbumHeardIndex } from '../util/album-heard.js?v=237';
import { releaseKind } from '../util/release-size.js?v=237';
import { loadFiltros, buildFilterContext, applyDiscoverFilters } from '../util/discover-filters.js?v=237';
...
import {
  ...
  botonesBaseHtml,
  conectarBotonesBase,
} from './discover-common.js?v=237';
import { estadoNativoDiscografia } from '../api.js?v=237';
