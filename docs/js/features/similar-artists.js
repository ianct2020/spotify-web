import { spotifyFetch, createPlaylist, addTracksToPlaylist, invalidatePlaylistsCache } from '../api.js?v=229';
import { hasKey, setKey, getSimilarArtists, getArtistTopTracks } from '../api/lastfm.js?v=229';
