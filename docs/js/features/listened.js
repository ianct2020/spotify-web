import { getAllPlaylistItems, getBestAvailableLikes, addTracksToPlaylist, removeTracksFromPlaylist } from '../api.js?v=58';
import { idbGetCached, idbSetCached, idbGetTimestamp, idbDel } from '../idb.js?v=58';
import { escapeHtml, confirmModal } from '../ui/components.js?v=58';
import { showToast } from '../ui/toast.js?v=58';
import { getListenedPlaylist, groupItemsByAlbum, openListenedAlbumsPicker, albumKey, baseName, norm } from './listened-shared.js?v=58';
