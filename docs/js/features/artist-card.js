...
import { loadHistoryStats, isOwner } from './history-data.js?v=113';
import { escapeHtml } from '../ui/components.js?v=113';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=113';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=113';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=113';
import { openTrackCard } from './track-card.js?v=113';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=113';
