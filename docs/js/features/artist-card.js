...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=234';
...
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=234';
import { openModal, closeTop } from '../ui/modal-stack.js?v=234';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=234';
import { coverUrl } from '../util/cover-size.js?v=234';
import { getArtistLikePreview } from '../util/artist-preview.js?v=234';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=234';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=234';
import { albumsDeArtista } from '../util/artist-albums.js?v=234';
