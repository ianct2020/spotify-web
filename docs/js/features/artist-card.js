...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=126';
import { escapeHtml } from '../ui/components.js?v=126';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=126';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=126';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=126';
import { openTrackCard } from './track-card.js?v=126';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=126';
