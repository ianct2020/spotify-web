...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=218';
...
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=218';
import { openModal, closeTop } from '../ui/modal-stack.js?v=218';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=218';
import { coverUrl } from '../util/cover-size.js?v=218';
import { getArtistLikePreview } from '../util/artist-preview.js?v=218';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=218';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=218';
import { albumsDeArtista } from '../util/artist-albums.js?v=218';
