...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=243';
...
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=243';
import { openTrackCard } from './track-card.js?v=243';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=243';
import { openModal, closeTop } from '../ui/modal-stack.js?v=243';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=243';
import { coverUrl } from '../util/cover-size.js?v=243';
import { getArtistLikePreview } from '../util/artist-preview.js?v=243';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=243';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=243';
import { albumsDeArtista } from '../util/artist-albums.js?v=243';
