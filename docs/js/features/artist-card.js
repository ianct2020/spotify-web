...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=167';
...
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=167';
import { openTrackCard } from './track-card.js?v=167';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=167';
import { openModal, closeTop } from '../ui/modal-stack.js?v=167';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=167';
import { coverUrl } from '../util/cover-size.js?v=167';
import { getArtistLikePreview } from '../util/artist-preview.js?v=167';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=167';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=167';
import { albumsDeArtista } from '../util/artist-albums.js?v=167';
