...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=137';
import { escapeHtml } from '../ui/components.js?v=137';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=137';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=137';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=137';
import { openTrackCard } from './track-card.js?v=137';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=137';
