...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=127';
import { escapeHtml } from '../ui/components.js?v=127';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=127';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=127';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=127';
import { openTrackCard } from './track-card.js?v=127';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=127';
