...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=132';
import { escapeHtml } from '../ui/components.js?v=132';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=132';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=132';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=132';
import { openTrackCard } from './track-card.js?v=132';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=132';
