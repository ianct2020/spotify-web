...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=134';
import { escapeHtml } from '../ui/components.js?v=134';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=134';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=134';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=134';
import { openTrackCard } from './track-card.js?v=134';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=134';
