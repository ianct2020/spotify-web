...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=135';
import { escapeHtml } from '../ui/components.js?v=135';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=135';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=135';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=135';
import { openTrackCard } from './track-card.js?v=135';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=135';
