...
import { loadHistoryStats, isOwner } from './history-data.js?v=123';
import { escapeHtml } from '../ui/components.js?v=123';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=123';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=123';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=123';
import { openTrackCard } from './track-card.js?v=123';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=123';
