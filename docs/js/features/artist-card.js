...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=169';
...
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=169';
import { openModal, closeTop } from '../ui/modal-stack.js?v=169';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=169';
import { coverUrl } from '../util/cover-size.js?v=169';
import { getArtistLikePreview } from '../util/artist-preview.js?v=169';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=169';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=169';
import { albumsDeArtista } from '../util/artist-albums.js?v=169';
