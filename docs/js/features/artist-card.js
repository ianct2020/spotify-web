...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=133';
import { escapeHtml } from '../ui/components.js?v=133';
import { getPreview, getArtistTopPreview } from '../api/preview-providers.js?v=133';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=133';
import { hasUsername, loadTopLifetime } from '../api/statsfm.js?v=133';
import { openTrackCard } from './track-card.js?v=133';
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=133';
