...
import { loadHistoryStats, loadArtistTracks, isOwner } from './history-data.js?v=199';
...
import { spotifyFetch, getBestAvailableLikes } from '../api.js?v=199';
import { openModal, closeTop } from '../ui/modal-stack.js?v=199';
import { firstArtistName, artistNames, resolveArtistName, looksLikeArtistChain } from '../util/artist-name.js?v=199';
import { coverUrl } from '../util/cover-size.js?v=199';
import { getArtistLikePreview } from '../util/artist-preview.js?v=199';
import { skelCardBody, skelTrackRows, skelBox } from '../ui/skeleton.js?v=199';
import { fmtDia, fmtDiaCorto } from '../util/fecha.js?v=199';
import { albumsDeArtista } from '../util/artist-albums.js?v=199';
