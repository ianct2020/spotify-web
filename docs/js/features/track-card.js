...
import { loadTrackPlays, loadTrackDetail, loadHistoryStats, isOwner } from './history-data.js?v=123';
...
import { hasUsername, findTrackId, getTrackCurrentStats, loadTopLifetime } from '../api/statsfm.js?v=123';
import { openAlbumCard } from './album-card.js?v=123';
import { openModal, closeTop } from '../ui/modal-stack.js?v=123';
import { getBestAvailableLikes } from '../api.js?v=123';
