...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=212';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=212';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=212';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=212';
import { escapeHtml, pageHeader } from '../ui/components.js?v=212';
import { showToast } from '../ui/toast.js?v=212';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=212';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=212';
...
import { albumKey } from '../util/album-key.js?v=212';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=212';
import { createHiddenStore } from '../util/hidden-sync.js?v=212';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=212';
import { mountBottom } from '../ui/bottom-layer.js?v=212';
import { coverUrl } from '../util/cover-size.js?v=212';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=212';
