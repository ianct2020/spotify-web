...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=168';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=168';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=168';
import { escapeHtml, pageHeader } from '../ui/components.js?v=168';
import { showToast } from '../ui/toast.js?v=168';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=168';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=168';
...
import { albumKey } from '../util/album-key.js?v=168';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=168';
import { createHiddenStore } from '../util/hidden-sync.js?v=168';
import { mountBottom } from '../ui/bottom-layer.js?v=168';
