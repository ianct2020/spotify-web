...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=240';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=240';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=240';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=240';
import { escapeHtml, pageHeader } from '../ui/components.js?v=240';
import { showToast } from '../ui/toast.js?v=240';
import { wireHoverMarquee, hoverMarqueeSpan } from '../ui/hover-marquee.js?v=240';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=240';
...
import { albumKey } from '../util/album-key.js?v=240';
import { resolveAlbumId } from '../util/album-resolver.js?v=240';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=240';
import { createHiddenStore } from '../util/hidden-sync.js?v=240';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=240';
import { mountBottom } from '../ui/bottom-layer.js?v=240';
import { coverUrl } from '../util/cover-size.js?v=240';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=240';
import { prefKey, migratePrefKey } from '../storage.js?v=240';
import { iconoPlay, iconoPausa, iconoPuntos, iconoOjo, iconoOjoTachado } from '../ui/icons.js?v=240';
