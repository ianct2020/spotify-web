...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=207';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=207';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=207';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=207';
import { escapeHtml, pageHeader } from '../ui/components.js?v=207';
import { showToast } from '../ui/toast.js?v=207';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=207';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=207';
...
import { albumKey } from '../util/album-key.js?v=207';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=207';
import { createHiddenStore } from '../util/hidden-sync.js?v=207';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=207';
import { mountBottom } from '../ui/bottom-layer.js?v=207';
import { coverUrl } from '../util/cover-size.js?v=207';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=207';
