...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=210';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=210';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=210';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=210';
import { escapeHtml, pageHeader } from '../ui/components.js?v=210';
import { showToast } from '../ui/toast.js?v=210';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=210';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=210';
import { getPreview } from '../api/preview-providers.js?v=210';
import { togglePreview, playingKey } from '../ui/preview-player.js?v=210';
import { openAlbumCard } from './album-card.js?v=210';
import { albumKey } from '../util/album-key.js?v=210';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=210';
import { createHiddenStore } from '../util/hidden-sync.js?v=210';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=210';
import { mountBottom } from '../ui/bottom-layer.js?v=210';
import { coverUrl } from '../util/cover-size.js?v=210';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=210';
