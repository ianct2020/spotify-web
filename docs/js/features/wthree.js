...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=208';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=208';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=208';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=208';
import { escapeHtml, pageHeader } from '../ui/components.js?v=208';
import { showToast } from '../ui/toast.js?v=208';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=208';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=208';
...
import { albumKey } from '../util/album-key.js?v=208';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=208';
import { createHiddenStore } from '../util/hidden-sync.js?v=208';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=208';
import { mountBottom } from '../ui/bottom-layer.js?v=208';
import { coverUrl } from '../util/cover-size.js?v=208';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=208';
