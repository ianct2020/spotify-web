...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getPlaylistSnapshotId, getCachedPlaylistSnapshot, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=133';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=133';
import { escapeHtml, pageHeader } from '../ui/components.js?v=133';
import { showToast } from '../ui/toast.js?v=133';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=133';
import { openModal, closeTop, closeById } from '../ui/modal-stack.js?v=133';
...
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=133';
