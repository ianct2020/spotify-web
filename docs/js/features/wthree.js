...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=166';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=166';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=166';
import { escapeHtml, pageHeader } from '../ui/components.js?v=166';
import { showToast } from '../ui/toast.js?v=166';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=166';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=166';
...
import { albumKey } from '../util/album-key.js?v=166';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=166';
import { createHiddenStore } from '../util/hidden-sync.js?v=166';
import { mountBottom } from '../ui/bottom-layer.js?v=166';
