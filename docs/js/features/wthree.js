...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=233';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=233';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=233';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=233';
import { escapeHtml, pageHeader } from '../ui/components.js?v=233';
import { showToast } from '../ui/toast.js?v=233';
import { wireHoverMarquee, hoverMarqueeSpan } from '../ui/hover-marquee.js?v=233';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=233';
...
import { resolveAlbumId } from '../util/album-resolver.js?v=233';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=233';
import { createHiddenStore } from '../util/hidden-sync.js?v=233';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=233';
import { mountBottom } from '../ui/bottom-layer.js?v=233';
import { coverUrl } from '../util/cover-size.js?v=233';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=233';
