...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=169';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=169';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=169';
import { escapeHtml, pageHeader } from '../ui/components.js?v=169';
import { showToast } from '../ui/toast.js?v=169';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=169';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=169';
...
import { albumKey } from '../util/album-key.js?v=169';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=169';
import { createHiddenStore } from '../util/hidden-sync.js?v=169';
import { mountBottom } from '../ui/bottom-layer.js?v=169';
