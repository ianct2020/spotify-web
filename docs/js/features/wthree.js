...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=167';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=167';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=167';
import { escapeHtml, pageHeader } from '../ui/components.js?v=167';
import { showToast } from '../ui/toast.js?v=167';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=167';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=167';
import { getPreview } from '../api/preview-providers.js?v=167';
import { togglePreview, playingKey } from '../ui/preview-player.js?v=167';
import { openAlbumCard } from './album-card.js?v=167';
import { albumKey } from '../util/album-key.js?v=167';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=167';
import { createHiddenStore } from '../util/hidden-sync.js?v=167';
import { mountBottom } from '../ui/bottom-layer.js?v=167';
import { coverUrl } from '../util/cover-size.js?v=167';
