...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=228';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=228';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=228';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=228';
import { escapeHtml, pageHeader } from '../ui/components.js?v=228';
import { showToast } from '../ui/toast.js?v=228';
import { wireHoverMarquee, hoverMarqueeSpan } from '../ui/hover-marquee.js?v=228';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=228';
import { getPreview } from '../api/preview-providers.js?v=228';
import { togglePreview, playingKey } from '../ui/preview-player.js?v=228';
import { openAlbumCard } from './album-card.js?v=228';
import { albumKey } from '../util/album-key.js?v=228';
import { resolveAlbumId } from '../util/album-resolver.js?v=228';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=228';
import { createHiddenStore } from '../util/hidden-sync.js?v=228';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=228';
import { mountBottom } from '../ui/bottom-layer.js?v=228';
import { coverUrl } from '../util/cover-size.js?v=228';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=228';
