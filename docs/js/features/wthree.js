...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=239';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=239';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=239';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=239';
import { escapeHtml, pageHeader } from '../ui/components.js?v=239';
import { showToast } from '../ui/toast.js?v=239';
import { wireHoverMarquee, hoverMarqueeSpan } from '../ui/hover-marquee.js?v=239';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=239';
...
import { albumKey } from '../util/album-key.js?v=239';
import { resolveAlbumId } from '../util/album-resolver.js?v=239';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=239';
import { createHiddenStore } from '../util/hidden-sync.js?v=239';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=239';
import { mountBottom } from '../ui/bottom-layer.js?v=239';
import { coverUrl } from '../util/cover-size.js?v=239';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=239';
import { prefKey, migratePrefKey } from '../storage.js?v=239';
import { iconoPlay, iconoPausa, iconoPuntos, iconoOjo, iconoOjoTachado } from '../ui/icons.js?v=239';
