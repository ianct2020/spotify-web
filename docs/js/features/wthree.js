...
import { spotifyFetch, getAllPlaylistItems, getAllUserPlaylists, addTracksToPlaylist, removeTracksFromPlaylist, reorderPlaylistItems, getCachedPlaylistItems, updatePlaylistItemsCache, getBestAvailableLikes } from '../api.js?v=206';
import { vigilarRuta } from '../util/vigencia-ruta.js?v=206';
import { patchPlaylistItems, buildCachedItem } from '../util/playlist-cache-patch.js?v=206';
import { loadHistoryStats, loadListenedAlbums, isOwner, ownerLockedMessage } from './history-data.js?v=206';
import { escapeHtml, pageHeader } from '../ui/components.js?v=206';
import { showToast } from '../ui/toast.js?v=206';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=206';
import { openModal, closeById, closeModal } from '../ui/modal-stack.js?v=206';
import { getPreview } from '../api/preview-providers.js?v=206';
import { togglePreview, playingKey } from '../ui/preview-player.js?v=206';
import { openAlbumCard } from './album-card.js?v=206';
import { albumKey } from '../util/album-key.js?v=206';
import { computeUpdatedPickPositions } from '../util/reorder-shifts.js?v=206';
import { createHiddenStore } from '../util/hidden-sync.js?v=206';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=206';
import { mountBottom } from '../ui/bottom-layer.js?v=206';
import { coverUrl } from '../util/cover-size.js?v=206';
import { insercionPorPuntero, moverA, indicadorPara } from '../util/reorder-drop.js?v=206';
