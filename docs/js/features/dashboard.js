import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=129';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=129';
import { openModal, closeTop } from '../ui/modal-stack.js?v=129';
import { showToast } from '../ui/toast.js?v=129';
import { openListenedAlbumsPicker } from './listened-shared.js?v=129';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=129';
import { getArtistTopPreview } from '../api/preview-providers.js?v=129';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=129';
import { hasUsername, getUsername } from '../api/statsfm.js?v=129';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=129';
