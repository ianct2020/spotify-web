import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=179';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=179';
import { openModal, closeTop } from '../ui/modal-stack.js?v=179';
import { showToast } from '../ui/toast.js?v=179';
import { openListenedAlbumsPicker } from './listened-shared.js?v=179';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=179';
import { getArtistLikePreview } from '../util/artist-preview.js?v=179';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=179';
import { armRevealAll } from '../ui/reveal.js?v=179';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=179';
import { getKey as getLastfmKey, setKey as setLastfmKey, clearKey as clearLastfmKey, isDefaultKey as lastfmIsDefaultKey } from '../api/lastfm.js?v=179';
...
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=179';
