import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=165';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=165';
import { openModal, closeTop } from '../ui/modal-stack.js?v=165';
import { showToast } from '../ui/toast.js?v=165';
import { openListenedAlbumsPicker } from './listened-shared.js?v=165';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=165';
import { getArtistLikePreview } from '../util/artist-preview.js?v=165';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=165';
import { armRevealAll } from '../ui/reveal.js?v=165';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=165';
import { getKey as getLastfmKey, setKey as setLastfmKey, clearKey as clearLastfmKey, isDefaultKey as lastfmIsDefaultKey } from '../api/lastfm.js?v=165';
...
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=165';
import { openArtistCard } from './artist-card.js?v=165';
import { openAlbumCard } from './album-card.js?v=165';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=165';
