import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=140';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=140';
import { openModal, closeTop } from '../ui/modal-stack.js?v=140';
import { showToast } from '../ui/toast.js?v=140';
import { openListenedAlbumsPicker } from './listened-shared.js?v=140';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=140';
import { getArtistTopPreview } from '../api/preview-providers.js?v=140';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=140';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=140';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=140';
