import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=111';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=111';
import { openModal, closeTop } from '../ui/modal-stack.js?v=111';
import { showToast } from '../ui/toast.js?v=111';
import { openListenedAlbumsPicker } from './listened-shared.js?v=111';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=111';
import { getArtistTopPreview } from '../api/preview-providers.js?v=111';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=111';
import { hasUsername, getUsername } from '../api/statsfm.js?v=111';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=111';
import { openArtistCard } from './artist-card.js?v=111';
