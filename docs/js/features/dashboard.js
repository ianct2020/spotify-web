import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=128';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=128';
import { openModal, closeTop } from '../ui/modal-stack.js?v=128';
import { showToast } from '../ui/toast.js?v=128';
import { openListenedAlbumsPicker } from './listened-shared.js?v=128';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=128';
import { getArtistTopPreview } from '../api/preview-providers.js?v=128';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=128';
import { hasUsername, getUsername } from '../api/statsfm.js?v=128';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=128';
import { openArtistCard } from './artist-card.js?v=128';
import { openAlbumCard } from './album-card.js?v=128';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=128';
import { isJunkTrack } from '../util/junk.js?v=128';
