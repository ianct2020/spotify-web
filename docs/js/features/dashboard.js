import { getAllLikedTracks, getLikesPartialInfo, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=237';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=237';
import { openModal, closeTop } from '../ui/modal-stack.js?v=237';
import { showToast } from '../ui/toast.js?v=237';
import { openListenedAlbumsPicker, getListenedPlaylist } from './listened-shared.js?v=237';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=237';
import { getArtistLikePreview } from '../util/artist-preview.js?v=237';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=237';
import { armRevealAll } from '../ui/reveal.js?v=237';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=237';
import { getKey as getLastfmKey, setKey as setLastfmKey, clearKey as clearLastfmKey, isDefaultKey as lastfmIsDefaultKey } from '../api/lastfm.js?v=237';
import { prefKey, migratePrefKey } from '../storage.js?v=237';
import { alpha } from '../ui/theme-panel.js?v=237';
...
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=237';
import { openArtistCard } from './artist-card.js?v=237';
import { openAlbumCard } from './album-card.js?v=237';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=237';
