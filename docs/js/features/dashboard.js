import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=147';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=147';
import { openModal, closeTop } from '../ui/modal-stack.js?v=147';
import { showToast } from '../ui/toast.js?v=147';
import { openListenedAlbumsPicker } from './listened-shared.js?v=147';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=147';
import { getArtistTopPreview } from '../api/preview-providers.js?v=147';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=147';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=147';
import { getKey as getLastfmKey, setKey as setLastfmKey, clearKey as clearLastfmKey, isDefaultKey as lastfmIsDefaultKey } from '../api/lastfm.js?v=147';
...
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=147';
import { openArtistCard } from './artist-card.js?v=147';
import { openAlbumCard } from './album-card.js?v=147';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=147';
