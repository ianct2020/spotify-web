import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=133';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=133';
import { openModal, closeTop } from '../ui/modal-stack.js?v=133';
import { showToast } from '../ui/toast.js?v=133';
import { openListenedAlbumsPicker } from './listened-shared.js?v=133';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=133';
import { getArtistTopPreview } from '../api/preview-providers.js?v=133';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=133';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=133';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=133';
...
import { isJunkTrack } from '../util/junk.js?v=133';
