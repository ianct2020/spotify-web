import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=134';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=134';
import { openModal, closeTop } from '../ui/modal-stack.js?v=134';
import { showToast } from '../ui/toast.js?v=134';
import { openListenedAlbumsPicker } from './listened-shared.js?v=134';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=134';
import { getArtistTopPreview } from '../api/preview-providers.js?v=134';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=134';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=134';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=134';
import { openArtistCard } from './artist-card.js?v=134';
import { openAlbumCard } from './album-card.js?v=134';
