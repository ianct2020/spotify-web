import { getAllLikedTracks, getLikesPartialInfo, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=201';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=201';
import { openModal, closeTop } from '../ui/modal-stack.js?v=201';
import { showToast } from '../ui/toast.js?v=201';
import { openListenedAlbumsPicker, getListenedPlaylist } from './listened-shared.js?v=201';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=201';
import { getArtistLikePreview } from '../util/artist-preview.js?v=201';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=201';
import { armRevealAll } from '../ui/reveal.js?v=201';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=201';
import { getKey as getLastfmKey, setKey as setLastfmKey, clearKey as clearLastfmKey, isDefaultKey as lastfmIsDefaultKey } from '../api/lastfm.js?v=201';
...
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=201';
import { openArtistCard } from './artist-card.js?v=201';
import { openAlbumCard } from './album-card.js?v=201';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=201';
import { isJunkTrack } from '../util/junk.js?v=201';
