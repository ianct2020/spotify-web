import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=118';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=118';
import { openModal, closeTop } from '../ui/modal-stack.js?v=118';
import { showToast } from '../ui/toast.js?v=118';
import { openListenedAlbumsPicker } from './listened-shared.js?v=118';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=118';
import { getArtistTopPreview } from '../api/preview-providers.js?v=118';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=118';
import { hasUsername, getUsername } from '../api/statsfm.js?v=118';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=118';
