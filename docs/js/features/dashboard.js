import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=137';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=137';
import { openModal, closeTop } from '../ui/modal-stack.js?v=137';
import { showToast } from '../ui/toast.js?v=137';
import { openListenedAlbumsPicker } from './listened-shared.js?v=137';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=137';
import { getArtistTopPreview } from '../api/preview-providers.js?v=137';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=137';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=137';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=137';
