import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=116';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=116';
import { openModal, closeTop } from '../ui/modal-stack.js?v=116';
import { showToast } from '../ui/toast.js?v=116';
import { openListenedAlbumsPicker } from './listened-shared.js?v=116';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=116';
import { getArtistTopPreview } from '../api/preview-providers.js?v=116';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=116';
import { hasUsername, getUsername } from '../api/statsfm.js?v=116';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=116';
import { openArtistCard } from './artist-card.js?v=116';
