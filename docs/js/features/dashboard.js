import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=138';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=138';
import { openModal, closeTop } from '../ui/modal-stack.js?v=138';
import { showToast } from '../ui/toast.js?v=138';
import { openListenedAlbumsPicker } from './listened-shared.js?v=138';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=138';
import { getArtistTopPreview } from '../api/preview-providers.js?v=138';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=138';
import { hasUsername, getUsername, setUsername } from '../api/statsfm.js?v=138';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=138';
import { openArtistCard } from './artist-card.js?v=138';
import { openAlbumCard } from './album-card.js?v=138';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=138';
import { isJunkTrack } from '../util/junk.js?v=138';
