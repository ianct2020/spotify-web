import { getAllLikedTracks, invalidateLikesCache, exportAllData, importAllData, getCurrentUserId, syncLikesIncremental, getLikesCacheTimestamp, getBestAvailableLikes, getAllPlaylistItems } from '../api.js?v=124';
import { showProgress, hideProgress, alertModal, escapeHtml, pageHeader } from '../ui/components.js?v=124';
import { openModal, closeTop } from '../ui/modal-stack.js?v=124';
import { showToast } from '../ui/toast.js?v=124';
import { openListenedAlbumsPicker } from './listened-shared.js?v=124';
import { loadHistoryStats, loadListenedAlbums } from './history-data.js?v=124';
import { getArtistTopPreview } from '../api/preview-providers.js?v=124';
import { hoverIn, hoverOut } from '../ui/preview-player.js?v=124';
import { hasUsername, getUsername } from '../api/statsfm.js?v=124';
import { loadHistoryStats as _loadStatsForCounter } from './history-data.js?v=124';
import { openArtistCard } from './artist-card.js?v=124';
import { openAlbumCard } from './album-card.js?v=124';
import { activateMarquee, marqueeSpan } from '../ui/marquee.js?v=124';
