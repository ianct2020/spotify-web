...
import { getArtistAlbums, searchArtistByName, getAlbumTracks, saveToLibrary, saveAlbumsToLibrary, createPlaylist, addTracksToPlaylist } from '../api.js?v=212';
import { albumKey } from '../util/album-key.js?v=212';
import { cardKey, cardKeyLegacy, albumCreditName, keyOfPlaylistTrack } from '../util/discover-key.js?v=212';
import { escapeHtml } from '../ui/components.js?v=212';
...
import { createHiddenStore, createLocalStore } from '../util/hidden-sync.js?v=212';
import { recuperarUriDeAlbumKey } from '../util/hidden-recover.js?v=212';
import { getPreview } from '../api/preview-providers.js?v=212';
import { togglePreview, playingKey, attachHover } from '../ui/preview-player.js?v=212';
import { coverUrl } from '../util/cover-size.js?v=212';
import { FILTROS as FILTROS_DEF, saveFiltros } from '../util/discover-filters.js?v=212';
import { esEPoAlbum } from '../util/release-size.js?v=212';
