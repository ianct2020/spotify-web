import { isLoggedIn, loginWithSpotify, logout } from './auth.js?v=79';
import { getUserProfile, spotifyFetch, tryAutoLoadUserBackup } from './api.js?v=79';
import { getValidToken } from './auth.js?v=79';
import { cacheClearAll } from './storage.js?v=79';
import { idbClearAll } from './idb.js?v=79';
import { registerRoute, initRouter, navigate } from './router.js?v=79';
import { showToast } from './ui/toast.js?v=79';

import { render as renderSync } from './features/sync.js?v=79';
import { render as renderDedupe } from './features/dedupe.js?v=79';
import { render as renderDupalbums } from './features/duplicate-albums.js?v=79';
import { render as renderZombies } from './features/zombies.js?v=79';
import { render as renderVersions } from './features/versions.js?v=79';
import { render as renderDashboard } from './features/dashboard.js?v=79';
import { render as renderSmart } from './features/smart.js?v=79';
import { render as renderSimilar } from './features/similar-artists.js?v=79';
import { render as renderRabbit } from './features/rabbit-hole.js?v=79';
import { render as renderByGenre } from './features/by-genre.js?v=79';
import { render as renderByArtist } from './features/by-artist.js?v=79';
import { render as renderRecs } from './features/recommendations.js?v=79';
import { render as renderListened } from './features/listened.js?v=79';
import { render as renderWrapped } from './features/wrapped.js?v=79';
import { render as renderZeroPlays } from './features/zero-plays.js?v=79';
import { render as renderSearchLikes } from './features/search-likes.js?v=79';
