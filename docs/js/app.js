import { isLoggedIn, loginWithSpotify, logout } from './auth.js?v=158';
import { spotifyFetch, tryAutoLoadUserBackup } from './api.js?v=158';
import { getValidToken } from './auth.js?v=158';
import { cacheClearAll } from './storage.js?v=158';
import { idbClearAll } from './idb.js?v=158';
import { registerRoute, initRouter } from './router.js?v=158';
import { showToast } from './ui/toast.js?v=158';
import { pageHeader } from './ui/components.js?v=158';
import { installCrashGuard } from './ui/crash-guard.js?v=158';
import { getStack } from './ui/modal-stack.js?v=158';
import { installBackToTop } from './ui/back-to-top.js?v=158';
import { applyStoredTheme, openThemePanel } from './ui/theme-panel.js?v=158';

import { render as renderSync } from './features/sync.js?v=158';
import { render as renderDedupe } from './features/dedupe.js?v=158';
import { render as renderDupalbums } from './features/duplicate-albums.js?v=158';
import { render as renderZombies } from './features/zombies.js?v=158';
import { render as renderVersions } from './features/versions.js?v=158';
import { render as renderDashboard } from './features/dashboard.js?v=158';
import { render as renderSmart } from './features/smart.js?v=158';
import { render as renderSimilar } from './features/similar-artists.js?v=158';
import { render as renderRabbit } from './features/rabbit-hole.js?v=158';
import { render as renderByGenre } from './features/by-genre.js?v=158';
import { render as renderByArtist } from './features/by-artist.js?v=158';
import { render as renderRecs } from './features/recommendations.js?v=158';
import { render as renderListened } from './features/listened.js?v=158';
import { render as renderWrapped } from './features/wrapped.js?v=158';
import { render as renderRecords } from './features/records.js?v=158';
import { openImportHistory } from './features/import-history.js?v=158';
import { bindOwnerLockedButtons } from './features/history-data.js?v=158';
import { render as renderZeroPlays } from './features/zero-plays.js?v=158';
import { render as renderSkips } from './features/skips.js?v=158';
import { render as renderSearchLikes } from './features/search-likes.js?v=158';
import { render as renderWthree } from './features/wthree.js?v=158';
import { render as renderCovers } from './features/covers.js?v=158';
import { render as renderDiscoverArtists } from './features/discover-artists.js?v=158';
import { render as renderNewReleases } from './features/new-releases.js?v=158';
import { render as renderSinClasificar } from './features/sin-clasificar.js?v=158';
